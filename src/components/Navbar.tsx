...
export function Navbar({ onLogout, sidebarOpen, setSidebarOpen }: NavbarProps) {
  return (
    <motion.header
      ...
      className="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200/80 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between shadow-sm"
    >
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 select-none">
          <img src={Logo} alt="Logo" className="h-8 w-8 rounded-md shadow-sm" />
          <div>
            <h1 className="font-semibold tracking-tight text-gray-900 leading-none">Compliance Checker</h1>
